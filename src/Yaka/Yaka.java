...
public class Yaka implements YakaConstants {
	...
	static final public void valConst() throws ParseException {
		...
		case entier:
			...
			Yaka.declaration.majConstante(YakaTokenManager.entierLu);
			break;
		case ident:
			jj_consume_token(ident);
			break;
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x80000, 0x200, 0x0, 0x120000, 0x0, 0x8100, 0x0,
				0x1120000, 0x1120000, 0x0, 0x400000, 0x800000, 0x1120000,
				0x120000, 0x120000, 0x0, 0x400000, 0x800000, 0x1000000, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x100, 0x50, 0x100, 0x0, 0x200,
				0x80850, 0x80850, 0x3e400, 0xc0000, 0x300000, 0x80850, 0x850,
				0x50, 0x3e400, 0xc0000, 0x300000, 0x80000, };
	}
